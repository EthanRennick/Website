...
/** 
 * Draws many rectangles on the canvas 
 */ 
...
{ 
    ...
    for (i = 0; i < 100; i++) 
    {
        ...
        ctx.fillRect(Math.floor(Math.random() *300), Math.floor(Math.random() *300), Math.floor(Math.random() *100), Math.floor(Math.random() *100)); 
    }
} 